...
> 在初始化gitalk的过程中出现了403错误，发现是gitalk说大家使用某一链接太多次而失效了，最好自己部署gitalk配置中的proxy。这里我用的是从issues里面抄的一段网友的代码。遇到其他问题则可以去[gitalk](https://github.com/gitalk/gitalk)的issues板块查找相应问题。